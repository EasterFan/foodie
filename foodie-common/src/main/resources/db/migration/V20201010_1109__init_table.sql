...
CREATE TABLE `items_img` (
  ...
  `url` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片地址',
...
CREATE TABLE `items_param` (
  ...
  `produc_place` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '产地，例：中国江苏',
  `foot_period` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '保质期，例：180天',
  `brand` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '品牌名，例：三只大灰狼',
  ...
  `weight` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规格重量，例：35g',
  `storage_method` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '存储方法，例：常温5~25°',
  `eat_method` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '食用方式，例：开袋即食',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `updated_time` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `users` (
  ...
  `face` varchar(1024) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '头像',
